...
set.seed(123) 
cv.lasso <- glmnet::cv.glmnet(x = as.matrix(space), y = data$group, alpha = 0, family = "binomial")
# Fit the final model on the training data
model <- glmnet::glmnet(x = space, y = data$group, alpha = 0, family = "binomial",
...
set.seed(123) 
cv.lassoin <- glmnet::cv.glmnet(x = as.matrix(spacein), y = data$group, alpha = 0, family = "binomial")
# Fit the final model on the training data
modelin <- glmnet::glmnet(x = spacein, y = data$group, alpha = 0, family = "binomial",
